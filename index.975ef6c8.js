...
var _imageReplace = require("./scripts/imageReplace");
var _frogAIDrawingPng = require("./assets/frogAIDrawing.png");
var _frogAIDrawingPngDefault = parcelHelpers.interopDefault(_frogAIDrawingPng);
...
document.addEventListener("DOMContentLoaded", ()=>{
    const aboutImage = document.getElementById("about-image").querySelector("img");
    const observer = new IntersectionObserver((entries, observer)=>{
        entries.forEach((entry)=>{
            if (entry.isIntersecting) {
                (0, _imageReplace.substituteFrogImage)(entry.target, (0, _frogAIDrawingPngDefault.default));
...
},{"./scripts/scrollReveal":"54rka","./scripts/tiltAnimation":"72kAb","./data/scrollRevealConfig":"5aORV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./scripts/imageReplace":"dy0yK","./assets/frogAIDrawing.png":"3mfU0"}],"54rka":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dy0yK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "substituteFrogImage", ()=>substituteFrogImage);
function substituteFrogImage(imageElement, newImageSrc, fadeOutDuration = 1000, delay = 3000) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3mfU0":[function(require,module,exports,__globalThis) {
module.exports = require("fdf8252211e2f5b8").getBundleURL('bLxZJ') + "frogAIDrawing.1d5c5421.png" + "?" + Date.now();

},{"fdf8252211e2f5b8":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
